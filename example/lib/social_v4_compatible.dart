...
class AmitySocialV4Compatible extends StatefulWidget {
  final bool isShowMyCommunity;
  const AmitySocialV4Compatible({super.key, this.isShowMyCommunity = true});

  @override
  State<AmitySocialV4Compatible> createState() => _CommunityPageState();
}

class _CommunityPageState extends State<AmitySocialV4Compatible> {
  @override
  void initState() {
    super.initState();
